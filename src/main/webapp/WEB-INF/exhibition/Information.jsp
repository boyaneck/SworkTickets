...
<body class="d-flex flex-column min-vh-100">
	<div class="container"
		style="padding-bottom: 300px; padding-top: 50px;">
		...
		<c:forEach items="${fn:split(exhibition.exh_img, '/') }" var="item">
			<div style="text-align: center;">
				<img src="/images/${item}" alt="이미지" style="width: 100%;">
			</div>
		</c:forEach>
		<!--    테이블 -->
		<div class="container-fluid ta">
			<div class="row row1 row-cols-sm-2">
				...
				<div class="col-md-3  col-sm-8 col-8 t">
					${exhibition.exh_cs_phone }</div>
			</div>
			<div class="row row1 row-cols-sm-2">
			...
			<div class="row row1 row-cols-sm-2">
				...
				<div class="col-md-3  col-sm-8 col-8 t">
					${exhibition.exh_shipping_info }</div>
			</div>
			<div class="row row1 row-cols-sm-2">
