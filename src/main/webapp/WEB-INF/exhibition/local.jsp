...
// $(function() {
//     $("li").siblings().css({"font-weight": "bold", "color":"#7832f7"});
//   });
...
<body class="d-flex flex-column min-vh-100">
	...
	<div class="board">
      ...
      <div id="tabs">
         <ul id="tab" style="background-color: white; border-bottom: 1px solid gray !important; ">
   <c:forEach items="${loc}" var="loc_name" varStatus="status">
            <li class="loc_name" id="${status.count }" onclick="local_func('${loc_name}','${status.count}')"><a href="#tabs-1" class="a1">${loc_name}</a></li> 
   </c:forEach>
         </ul>
