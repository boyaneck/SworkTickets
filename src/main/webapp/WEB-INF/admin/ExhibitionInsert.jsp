...
<!-- 			</div> -->
			...
			<div class="input-group mb-3">
				...
				<input type="file" class="form-control innm" id="exh_img" name="uploadFile">
...
<!-- 				</div> -->
<%-- 				<input type="text" class="form-control innm" id="exh_shipping_info" name="exh_shipping_info" value="${exhibition.exh_shipping_info}"> --%>
<!-- 			</div> -->
<!-- 			<div class="input-group mb-3"> -->
<!-- 				<div class="input-group-prepend"> -->
...
<%-- 					id="exh_refund_info" name="exh_refund_info">${exhibition.exh_refund_info} --%>
<!-- 				</textarea> -->
<!-- 			</div> -->
