...
<body>
	...
	<div
		...
		<h2
			style="background-color: #f6f5f5; font-size: 30px; padding: 0; margin-bottom: 40px; text-align: center;">아이디찾기</h2>
		<div class="container-fluid" id="fluid-height"
			style="text-align: -webkit-center; background-color: white; padding: 0; width: 700px;">
			<div class="row">
			...
			<div class="row">
				...
				<div class="col-6">
					<input style="font-size: 16px;" id="email" name="mb_email"
			...
			<div class="row" style="margin-top: 50px !important;">
				...
				<div class="col-5" style="margin-bottom: 50px;">
					<c:forEach items="${memberList}" var="memberList">
						...
						<c:set var="index" value='${fn:length(memberList.mb_id)}' />
						<c:set var="sub"
							value='${fn:substring(memberList.mb_id,0,(index/2)+1) }***' />
